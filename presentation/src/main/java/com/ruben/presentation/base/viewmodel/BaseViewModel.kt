package com.ruben.presentation.base.viewmodel
...
import com.ruben.domain.base.Failure.FailureWithMessage
...
abstract class BaseViewModel : ViewModel() {
    ...
    private fun getFailure(throwable: Throwable, retryAction: () -> Unit): Failure {
        val failure = throwable as? Failure ?: FailureWithMessage(
